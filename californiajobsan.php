...
$new_name = 'californiajobsnow.com.csv';

$url = 'https://hallimjolken.com/api/v2/9to5/californiajobsnow.com.csv';
...
$fp = fopen("californiajobsnow.com.csv", "r");

$contents = fread($fp, filesize("californiajobsnow.com.csv"));

$fz = filesize("californiajobsnow.com.csv");
