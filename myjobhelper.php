...
<posterType/>
<salary/>
<postDate><![CDATA[ $adate-T15:$bdate ]]></postDate>
<updateDate/>
<categories>
...
for ($i = 0; $i < 100; $i++) {
	...
	echo "
<job>
<referenceId><![CDATA[ $id ]]></referenceId>
<url><![CDATA[ https://www.occuponsquebec.org/market-research-assistant/?id=$id ]]></url>";
	echo $resultado1;
    //echo "<br>";
}
echo "
